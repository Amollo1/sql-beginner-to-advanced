/*
=============================================================
The Database Creation and Table Setup Script (MySQL Version)
=============================================================
Script Purpose:
    This script creates a new MySQL database named 'BensDatabase'. 
...
WARNING:
    Running this script will drop the entire 'BensDatabase' database if it exists, 
...
DROP DATABASE IF EXISTS BensDatabase;
CREATE DATABASE BensDatabase;
USE BensDatabase;
...
INSERT INTO customers (id, first_name, country, score) VALUES
    (1, 'Mary', 'Kenya', 350),
    (2, 'Lincon', 'South Africa', 900),
    (3, 'Fred', 'Somalia', 750),
    (4, 'Onyango', 'Kenya', 500),
    (5, 'Tom', 'South Africa', 0);
